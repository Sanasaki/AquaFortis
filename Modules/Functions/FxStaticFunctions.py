...
#         if remainingInputs < inputPerThread:
#             inputPerThread = 1
...
def makeDir(pathToWrite: str) -> None:
    if not os.path.exists(pathToWrite):
        os.mkdir(pathToWrite)


def FxProcessTime(func: Callable[..., Any]) -> Callable[..., Any]:
    @wraps(func)
...
# def MolecularAnalysis(
#     frame,
#     travisInstructions: str = None,
#     workingDir: str = None,
#     timeBeforeKill: float = 0.2,
# ) -> None:
